...
-- ============================================================
-- 현 스키마(quiz_question) 로 마이그레이션됨. 기존 레거시 `quiz` 테이블·
-- `options`/`answer` 컬럼 표기는 폐기. question_no 컬럼 제거 후
-- difficulty 로 대체 (1=easy, 2=medium, 3=hard).

DELETE FROM quiz_question WHERE chapter = 'CH12' AND 'ch12-base' = ANY(tags);

INSERT INTO quiz_question (chapter, difficulty, question_type, question, choices, correct_answer, explanation, tags)
VALUES
...
('CH12', 1, 'multiple_choice',
 ...
 ARRAY['chapter:CH12','ch12-base','환자구분','국비','면제','감면','일반']),

-- [EASY 2] 원외처방 약제비 포함 여부
('CH12', 1, 'true_false',
 '보훈병원에서 발행한 처방전에 따라 일반 원외약국이 조제한 약제비는 보훈 심사위탁 대상에 포함된다. (O/X)',
 '["O","X"]'::jsonb,
 '0',
 'O. P08 1.가와 P16 제17조제3항에 따라 보훈병원 발행 처방전에 의한 원외조제 약제비는 심사위탁 범위에 포함됩니다. 일반 약국이더라도 처방전 발행기관이 보훈병원이면 위탁 심사 체계 안에 들어갑니다.',
 ARRAY['chapter:CH12','ch12-base','원외처방','심사위탁','P08','P16']),

-- [EASY 3] 약국 위탁수수료
('CH12', 1, 'numeric',
 '심사평가원이 보훈 약제비 명세서를 위탁 심사할 때 약국이 부담하는 청구건당 수수료는 몇 원인가요? (원)',
 NULL,
 '66',
 'P10 제3조에 따른 청구건당 위탁수수료는 입원 800원, 외래 248원, 약국 66원입니다. 약국은 세 구분 중 가장 낮은 66원을 부담합니다.',
 ARRAY['chapter:CH12','ch12-base','위탁수수료','심사평가원','P10']),
...
('CH12', 2, 'multiple_choice',
 ...
 ARRAY['chapter:CH12','ch12-base','참전유공자','감면율','90%','P05']),

-- [MEDIUM 5] 공상등구분 코드 매핑
('CH12', 2, 'multiple_choice',
 ...
 ARRAY['chapter:CH12','ch12-base','공상등구분','P08','코드','감면환자']),
...
('CH12', 2, 'multiple_choice',
 ...
 ARRAY['chapter:CH12','ch12-base','보훈청구액','계산식']),
...
('CH12', 2, 'multiple_choice',
 ...
 ARRAY['chapter:CH12','ch12-base','감면율','모수','P16','본인부담']),
...
('CH12', 2, 'multiple_choice',
 ...
 ARRAY['chapter:CH12','ch12-base','법령계층','P16','P15','P14','우선순위']),
...
('CH12', 2, 'multiple_choice',
 ...
 ARRAY['chapter:CH12','ch12-base','이의신청','90일','P10','심사']),

-- [MEDIUM 10] MT038 약국 사용 제한
('CH12', 2, 'true_false',
 '보훈병원 업무처리 기준(P08)에서 약국은 MT038 코드를 절대 사용하지 않으며, 공상등구분만 사용한다. (O/X)',
 '["O","X"]'::jsonb,
 '1',
 'X. P08 기준에서는 약국이 공상등구분을 사용하고 병원이 MT038을 사용하는 것이 맞습니다. 그러나 2025 요양급여비용 청구방법 작성요령에서는 도서벽지 60% 감면 약국의 경우 MT038=A를 사용하는 등 예외가 존재합니다. 따라서 약국은 항상 MT038을 사용하지 않는다고 일반화하면 안 됩니다.',
 ARRAY['chapter:CH12','ch12-base','MT038','약국','공상등구분','예외']),

-- [MEDIUM 11] 자가처치 치료재료 품목 수
('CH12', 2, 'multiple_choice',
 ...
 ARRAY['chapter:CH12','ch12-base','자가처치','P13','26품목','치료재료']),
...
('CH12', 3, 'multiple_choice',
 ...
 ARRAY['chapter:CH12','ch12-base','BZ401001','BZ499002','자가처치코드','P13']),

-- [HARD 13] 실제 청구 예시 – 보훈청구액
('CH12', 3, 'numeric',
 '2025 작성요령 예시(60% 감면)에서 요양급여비용총액1=22,860원, 본인일부부담금=2,700원, 청구액=16,060원일 때 보훈청구액은 얼마인가요? (원)',
 NULL,
 '4100',
 '보훈청구액 = 요양급여비용총액1 - 청구액 - 본인일부부담금 = 22,860 - 16,060 - 2,700 = 4,100원입니다. 요양급여비용총액1 = 청구액 + 본인일부부담금 + 보훈청구액 구조로 검증할 수 있습니다.',
 ARRAY['chapter:CH12','ch12-base','보훈청구액','계산예시','60%감면','4100']),
...
('CH12', 3, 'multiple_choice',
 ...
 ARRAY['chapter:CH12','ch12-base','심사위탁','제외범위','P08','급여약제비']),

-- [HARD 15] 보훈위탁진료 약국 MT038=A 조건
('CH12', 3, 'multiple_choice',
